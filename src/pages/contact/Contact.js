...
// Icons
import { BsEnvelopeFill, BsPhoneFill, BsFilePdfFill, BsDownload } from 'react-icons/bs';
...
const Contact = () => {
  ...
  return (
    <section className='contact-page pb-3 py-md-3 px-2' data-aos='fade-up' data-aos-delay='300'>
        ...
        <div className='row'>
          <div className='col'>
            ...
            <p className='intro contacts-intro text-center fs-5'>
              ...
              using the form or any of the other options below. I look forward to hearing from you soon!
            </p>
          ...
          <div className='row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3  d-flex justify-content-between'>
            <div className='col'>
              <div className='card py-3 shadow'>
                <div className='card-body d-flex justify-content-center flex-column align-items-center gap-4'>
                  <span className='fs-4'>
                    <a href='mailto:oneal.grant@outlook.com' style={{ textDecoration: 'none' }}>
                      <BsEnvelopeFill />
                    </a>
                  </span>
            ...
            <div className='col'>
              <div className='card py-3 shadow'>
                <div className='card-body d-flex justify-content-center flex-column align-items-center gap-4'>
                  <span className='fs-4'>
                    <a href='tel:07886028826' style={{ textDecoration: 'none' }}>
                      <BsPhoneFill />
                    </a>
                  </span>
